 ...
 * Version: 0.12.0 - 2015-07-21T04:27:20.535Z
 * License: MIT
 */
...
$templateCache.put("bootstrap/choices.tpl.html","<ul class=\"ui-select-choices ui-select-choices-content ui-select-dropdown dropdown-menu\" role=\"listbox\" ng-show=\"$select.items.length > 0\"><div class=\"ui-select-choices-header\" ng-if=\"$select.hasCheckboxes\"><p>Select <span class=\"ui-select-choices-toggle toggle-all\" ng-click=\"$select.toggleCheckboxes($event)\">All</span> | <span class=\"ui-select-choices-toggle toggle-none\" ng-click=\"$select.toggleCheckboxes($event)\">None</span></p></div><li class=\"ui-select-choices-group\" id=\"ui-select-choices-{{ $select.generatedId }}\"><div class=\"divider\" ng-show=\"$select.isGrouped && $index > 0\"></div><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label dropdown-header\" ng-bind=\"$group.name\"></div><div id=\"ui-select-choices-row-{{ $select.generatedId }}-{{$index}}\" class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\" role=\"option\"><a href=\"javascript:void(0)\" class=\"ui-select-choices-row-inner\"><input type=\"checkbox\" class=\"ui-select-choices-checkbox\"></a></div></li></ul>");
